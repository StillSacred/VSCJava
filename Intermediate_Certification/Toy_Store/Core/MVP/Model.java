...
import Core.Services.DrawingServices;
...
public class Model {
    protected final DrawingServices currentDrawingService;
    private final String path;

    public Model(String path) {
        currentDrawingService = new DrawingServices();
        this.path = path;
    }
    ...
    public DrawingServices currentDrawingService() {
